...
class Frame(ttk.Frame):
    def __init__(self, master=None):
        ...
        self.spinMaxLine = ttk.Spinbox(self, from_=1, to=7, increment=1, textvariable=self.maxLine, width=5, justify='center')
        ...
        self.spinMinEle = ttk.Spinbox(self, from_=0, to=7, increment=1, textvariable=self.minEle, width=5, justify='center')
        ...
        self.spinMaxEle = ttk.Spinbox(self, from_=0, to=7, increment=1, textvariable=self.maxEle, width=5, justify='center')
    ...
    def randomize(self, projectName, seed):
        if self.enabled.get():
            ...
            randomzier.randomize(maxLine=self.maxLine.get(), minEleSlot=self.minEle.get(), maxEleSlot=self.maxEle.get(), excludeGuest=self.excludeGuest.get())